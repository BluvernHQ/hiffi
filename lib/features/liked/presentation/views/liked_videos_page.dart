...
class _LikedVideosPageState extends State<LikedVideosPage> {
  static final _likedDateFormat = DateFormat.yMMMd();
                      ...
                      delegate: SliverChildBuilderDelegate(
                        (context, index) {
                          ...
                          return _LikedGridVideoCard(
                            item: item,
                            likedLabel: _likedDateFormat.format(item.upvotedAt),
                          );
                        },
                        childCount:
...
double _likedCardAspectRatio(BuildContext context) {
  ...
  final textSectionHeight =
      responsiveGridTextSectionHeight(context) + 8.h + 14.h;
      ...
      child: InkWell(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 8.h),
            SizedBox(
              height: responsiveGridTextSectionHeight(context) + 14.h,
              child: Column(
